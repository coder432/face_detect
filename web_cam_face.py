...
#path for cascades
casc_path_face=' enter cascade path here' 
#copy the location of face cascade as string eg(C:\opencv\opencv\sources\data\haarcascades\haarcascade_frontalface_default.xml)
